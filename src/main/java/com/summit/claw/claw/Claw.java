...
public class Claw extends JavaPlugin {
    ...
    public void onEnable() {
        if (this.getCommand("claw generate") == null) {
            ...
            Objects.requireNonNull(this.getCommand("claw generate")).setExecutor(new ClawCommand(this));
        }
        ...
        if (this.getCommand("claw open") == null) {
            ...
            Objects.requireNonNull(this.getCommand("claw open")).setExecutor(new ClawCommand(this));
        }
